...
<div id="ribbon">
<b>SortBy:</b>Name:&nbsp&nbsp<a href="search?category=<%=request.getParameter("category")%>&sortby=f_name&order=ASC"><input type="image" src="images/icons/up.png" height="15px" width="15px"></a>
<a href="search?category=<%=request.getParameter("category")%>&sortby=f_name&order=DESC"><input type="image" src="images/icons/down.png" height="15px" width="15px"></a>
||
<b>SortBy:</b>Price:&nbsp&nbsp<a href="search?category=<%=request.getParameter("category")%>&sortby=fee_to_work&order=ASC"><input type="image" src="images/icons/up.png" height="15px" width="15px"></a>
<a href="search?category=<%=request.getParameter("category")%>&sortby=fee_to_work&order=DESC"><input type="image" src="images/icons/down.png" height="15px" width="15px"></a>
...
String key=request.getParameter("key");
    ...
    p=new SearchDAO().getProfile(category,sortby,order);
...
<%
String subcategory=request.getParameter("category");//p.get(i).getCategory();
System.out.print ("hi this is"+request.getParameter("category"));
try{
